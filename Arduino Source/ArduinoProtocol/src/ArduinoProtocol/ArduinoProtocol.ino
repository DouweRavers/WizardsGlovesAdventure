...
void setThresholds()
{
  ...
  else
  {
    ...
    upper_threshold_thumb = 20, lower_threshold_thumb = -20,
    upper_threshold_index = 20, lower_threshold_index = -20,
    upper_threshold_middle = 20, lower_threshold_middle = -20,
    upper_threshold_ring = 20, lower_threshold_ring = -20,
    upper_threshold_pinky = 20, lower_threshold_pinky = -20;
  }
}
