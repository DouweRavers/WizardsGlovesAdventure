# 1 "c:\\Users\\douwe\\Projects\\WizardsGlovesAdventure\\Arduino Source\\ArduinoProtocol\\src\\ArduinoProtocol\\ArduinoProtocol.ino"
# 2 "c:\\Users\\douwe\\Projects\\WizardsGlovesAdventure\\Arduino Source\\ArduinoProtocol\\src\\ArduinoProtocol\\ArduinoProtocol.ino" 2
#define LeftHand false
# 11 "c:\\Users\\douwe\\Projects\\WizardsGlovesAdventure\\Arduino Source\\ArduinoProtocol\\src\\ArduinoProtocol\\ArduinoProtocol.ino"
#define thumbPort A7
#define indexPort A6
...
{
  // THUMB
  receiveAndFilterTouchSensor(thumb_raw_data, thumb_LP_data, A7);
  ...
  // INDEX
  receiveAndFilterTouchSensor(index_raw_data, index_LP_data, A6);
  ...
  // MIDDLE
  receiveAndFilterTouchSensor(middle_raw_data, middle_LP_data, A2);
  ...
  // RING
  receiveAndFilterTouchSensor(ring_raw_data, ring_LP_data, A1);
  ...
  // PINKY
  receiveAndFilterTouchSensor(pinky_raw_data, pinky_LP_data, A0);
...
void sendData()
{
  String payload = false ? "Lhand:" : "Rhand:";
  payload = payload + "{";
